...
libmm-venc-inc      += $(TOP)/device/realme/golf/hals/media/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += $(TOP)/device/realme/golf/hals/media/mm-video-v4l2/vidc/venc/inc
libmm-venc-inc      += device/realme/golf/hals/media/mm-core/inc
libmm-venc-inc      += device/realme/golf/hals/media/libstagefrighthw
libmm-venc-inc      += device/realme/golf/hals/media/libplatformconfig
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += device/realme/golf/hals/media/libc2dcolorconvert
